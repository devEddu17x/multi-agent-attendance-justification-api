...
- fechasAusencia: array de fechas de ausencia mencionadas (formato YYYY-MM-DD si es posible). Si el mensaje dice "ayer", "hoy", "el martes", etc., calcula la fecha exacta basándote en la fecha actual indicada por el mensaje del sistema. Si no hay fecha específica, usa [].
...
2. No inventes datos. Si un campo no aparece en el documento, usa null o [] segun corresponda.
