...
2. Si el mensaje menciona una falta, ausencia, tardanza, o adjunta documentos (certificados, notas, fotos), enruta a EXTRACTOR.
3. Responde ÚNICAMENTE con un JSON válido: {"nextAgent": "communicator" | "extractor"}
