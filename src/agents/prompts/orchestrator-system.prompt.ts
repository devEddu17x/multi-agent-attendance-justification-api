...
1. Si el mensaje menciona una falta, ausencia, tardanza, o solicitud de justificación (aunque no haya documentos), enruta a HISTORY para revisar el historial del alumno.
